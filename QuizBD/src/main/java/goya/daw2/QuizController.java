...
public class QuizController {
    ...
    public String mostrarResultado(HttpSession sesion, Model modelo) {
        ...
        Resultado nuevoResultado = new Resultado(nombre, casa, max);
    ...
    public String mostrarClasificacion(Model model) {
        List<Resultado> ultimosResultados = resultadoRepository.findFirst5ByOrderByIdDesc();
        model.addAttribute("resultados", ultimosResultados);
        return "puntuaciones";
    }
